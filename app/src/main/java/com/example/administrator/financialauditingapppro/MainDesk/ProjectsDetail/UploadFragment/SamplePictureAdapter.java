...
public class SamplePictureAdapter extends PictureAdapter {

    public SamplePictureAdapter(Context mContext, ArrayList<BeanPDUploadListItem.Faqentity> faqentities){
